...
This backlog tracks all **30 architectural enhancements, algorithmic optimizations, and user experience features** in the private engineering repository (`mbettan/bq-finops-optimizer-private`).
...
| :--- | :--- | :--- | :--- |
| **WS 1** | **Operational Health, Quota, Timeouts & GenAI Governance** | Proactive 429/quota throttling alerts (`>1%`), spend velocity (`+15%` drift), spend stability ($\text{CV}$), production GenAI & BQML workload attribution, preventive query timeouts & circuit breakers. | [#16](https://github.com/mbettan/bq-finops-optimizer-private/issues/16), [#17](https://github.com/mbettan/bq-finops-optimizer-private/issues/17), [#18](https://github.com/mbettan/bq-finops-optimizer-private/issues/18), [#25](https://github.com/mbettan/bq-finops-optimizer-private/issues/25), [#30](https://github.com/mbettan/bq-finops-optimizer-private/issues/30) |
| **WS 2** | **SQL Refactoring, Schema Denormalization, HLL & MVs** | Multi-rule SQL linter, AI Doctor join sequencing & CTE pushdown, `ARRAY<STRUCT>` schema denormalization, Materialized View Smart Tuning recommender, Dynamic `MERGE`/Subquery partition pruning, `HLL_COUNT` sketch rollup engine, Window function skew linter. | [#12](https://github.com/mbettan/bq-finops-optimizer-private/issues/12), [#13](https://github.com/mbettan/bq-finops-optimizer-private/issues/13), [#14](https://github.com/mbettan/bq-finops-optimizer-private/issues/14), [#15](https://github.com/mbettan/bq-finops-optimizer-private/issues/15), [#23](https://github.com/mbettan/bq-finops-optimizer-private/issues/23), [#24](https://github.com/mbettan/bq-finops-optimizer-private/issues/24), [#26](https://github.com/mbettan/bq-finops-optimizer-private/issues/26) |
| **WS 3** | **Storage Lifecycle, 90-Day Discount, Clones & Search Indexes** | 90-day long-term storage reset detector, zero-copy `CLONE`/`SNAPSHOT` arbitrage, partition cardinality & unclustered table guardrails, sparse point-lookup `CLUSTER BY` vs `CREATE SEARCH INDEX` advisor. | [#5](https://github.com/mbettan/bq-finops-optimizer-private/issues/5), [#7](https://github.com/mbettan/bq-finops-optimizer-private/issues/7), [#19](https://github.com/mbettan/bq-finops-optimizer-private/issues/19), [#27](https://github.com/mbettan/bq-finops-optimizer-private/issues/27) |
...
| **WS 5** | **Reservation Architecture Blueprint, Concurrency & BI Engine** | Automated 4-tier reservation blueprint + visual SVG diagram + Capacity DDL, orchestrator cron fan-out & cooldown sentinel, Continuous Queries & `ALTER BI_CAPACITY` pinning, OOM/spill failed compute profiler, concurrent duplicate query coalescer, scan vs compute stage profiler. | [#8](https://github.com/mbettan/bq-finops-optimizer-private/issues/8), [#9](https://github.com/mbettan/bq-finops-optimizer-private/issues/9), [#10](https://github.com/mbettan/bq-finops-optimizer-private/issues/10), [#21](https://github.com/mbettan/bq-finops-optimizer-private/issues/21), [#28](https://github.com/mbettan/bq-finops-optimizer-private/issues/28), [#29](https://github.com/mbettan/bq-finops-optimizer-private/issues/29) |
