...
# Fallback to 'test-project' if the environment variable is not set.
TEST_PROJECT_ID = os.getenv("BIGQUERY_PROJECT_ID", "test-project")
...
if TEST_PROJECT_ID == "test-project":
    pytestmark = pytest.mark.skip(
        reason="Skipping live integration tests because BIGQUERY_PROJECT_ID is set to the placeholder 'test-project'. Set it to a real GCP project to run live tests."
    )
