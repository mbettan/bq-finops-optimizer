...
def test_linter_sibling_parent_job_warning_propagation():
    ...
    with patch("src.main.init_bq_client_and_resolve_project") as mock_init:
        ...
        mock_init.return_value = (mock_bq_client, "test-project")
        ...
        mock_stage1_job.result.side_effect = single_pass_rows(mock_org_row)
        ...
        assert linter_result["project_id"] == "test-project"
